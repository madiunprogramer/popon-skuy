...
import (
	...
	"github.com/madiunprogramer/popon-skuy/src/libpsiphon"
	"github.com/madiunprogramer/libinject"
	"github.com/madiunprogramer/liblog"
	"github.com/madiunprogramer/libproxyrotator"
	"github.com/madiunprogramer/libredsocks"
	"github.com/madiunprogramer/libutils"
)

const (
	appName        = "Scrz Tunnel"
	appVersionName = " Popon-Skuy"
	appVersionCode = "1208 "

	copyrightYear   = "2020"
	copyrightAuthor = "Nando Scrz"
)
...
func GetConfigPath(filename string) string {
	return libutils.GetConfigPath("popon-skuy", filename)
}
...
liblog.LogInfo("=======[ Log info ]======= ", "INFO", liblog.Colors["R1"])
